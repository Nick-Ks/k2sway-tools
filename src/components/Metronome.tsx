  ...
  return (
    <div className="flex h-full flex-col p-6 overflow-hidden">
      ...
      <div className="w-full flex justify-between items-center mb-6">
        ...
        <div className="bg-slate-900 border border-slate-800 px-5 py-2.5 rounded-2xl text-ui-label text-cyan-400">
          {timeSignature} BEAT
        </div>
      </div>
      ...
      <div className="flex flex-col gap-5 mb-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-slate-900/50 p-4 rounded-3xl border border-slate-800 flex flex-col gap-3">
            <span className="text-ui-label text-center">박자수(Beats)</span>
          ...
          <div className="bg-slate-900/50 p-4 rounded-3xl border border-slate-800 flex flex-col gap-3">
            <span className="text-ui-label text-center">나누기(Subdiv)</span>
            <div className="flex gap-2">
              {[1, 2, 3, 4].map(opt => (
                <button
                  key={opt}
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative w-full bg-slate-950 rounded-[3rem] border border-slate-900/50 py-8 mb-6">
        ...
        <div className="mt-4 flex flex-col items-center gap-1">
          <span className="text-ui-label tracking-[0.25em]">ALLEGRO</span>
          <span className="text-ui-value italic">박자에 맞춰 찬양하세요</span>
        </div>
      </div>
      ...
      <div className="flex w-full flex-col gap-4">
        <div className="grid grid-cols-3 gap-3">
          ...
          >
            ...
            <span className="text-ui-label text-slate-300 leading-none">TAP</span>
            <span className="text-ui-value text-slate-400">템포 직접 맞추기</span>
          </button>
          ...
          >
            ...
            <span className="text-ui-button uppercase leading-none">
              {isPlaying ? '그만하기' : '시작하기'}
            </span>
          </button>
        </div>
